...
from mal2026.iterative_official_dual_agent_models import candidate_specs
from mal2026.iterative_official_dual_agent_protocol import CONFIG_PATH
from mal2026.iterative_official_dual_agent_selection import final_gate, score5_macro_recall, select_candidate
...
class OfficialDualAgentSelectionTest(unittest.TestCase):
    def setUp(self):
