...
class DecoderScoreConfig:
    ...
    def validate(self, *, require_dependencies: bool = True) -> None:
        ...
        batch_schedule = (self.per_device_train_batch_size, self.per_device_eval_batch_size, self.gradient_accumulation_steps)
        _need(batch_schedule in {(1, 2, 8), (1, 4, 8)}, "batch contract differs")
