...
from mal2026.solar_prompt_search_v2 import SearchConfigV2, aggregate_discovery, preflight, prepare, run_candidate
...
def main() -> int:
    ...
    config = SearchConfigV2.from_json(args.config)
    if args.stage == "prepare":
        ...
        if args.candidate is None:
            parser.error("--candidate is required for run")
