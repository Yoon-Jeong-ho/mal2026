#!/usr/bin/env bash
# Versioned wrapper: train first, then frozen validation under prompt5x10 v3.
set -Eeuo pipefail
...
export MAL2026_DIST100_VALIDATION_OUTPUT_SUBDIR="frozen_validation_judge_runs_essay_only_prompt5x10_v3"
